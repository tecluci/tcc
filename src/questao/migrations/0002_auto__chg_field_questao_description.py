...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Questao.description'
        db.alter_column(u'questao_questao', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Questao.description'
        db.alter_column(u'questao_questao', 'description', self.gf('django.db.models.fields.CharField')(max_length=90))
